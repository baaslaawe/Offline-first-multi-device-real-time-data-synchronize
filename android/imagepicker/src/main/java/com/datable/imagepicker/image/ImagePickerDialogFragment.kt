...
class ImagePickerDialogFragment : AppCompatDialogFragment(), View.OnClickListener {
    ...
    fun setIsFromAnotherAlbumApp(isFromAlbumApp: Boolean): ImagePickerDialogFragment {
        this.isFromAlbumApp = isFromAlbumApp
        return this
    }
    ...
    fun showDialog(fragmentManager: FragmentManager, cropEnable: Boolean, onImageDoneListener: OnImageDoneListener) {
    ...
    companion object {
        ...
        val REQUEST_CODE_PICK_ONE_IMAGE = 0x0101
        val REQUEST_CODE_PICK_MANY_IMAGE = 0x0102
        val REQUEST_CODE_CAMERA = 0x0103
        val REQUEST_CODE_EDIT_IMAGE = 0x0104

        private val DEFAULT_MAX_IMAGE_COUNT = 10
        ...
        fun newInstance(): ImagePickerDialogFragment = ImagePickerDialogFragment()
